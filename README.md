...
Serviço backend desenvolvido com **FastAPI** para processamento de
transações financeiras, garantindo o envio ao banco parceiro mesmo em
caso de falhas temporárias.
...
4.  Worker em background tenta novamente quando a transação estiver
    elegível.
